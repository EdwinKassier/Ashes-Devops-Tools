...
| <a name="output_keyring_self_link"></a> [keyring\_self\_link](#output\_keyring\_self\_link) | The full resource name of the KMS keyring: projects/<project>/locations/<location>/keyRings/<name>. |
<!-- END_TF_DOCS -->