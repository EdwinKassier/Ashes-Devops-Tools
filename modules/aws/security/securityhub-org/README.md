...
- resource.aws_securityhub_account.this (modules/aws/security/securityhub-org/main.tf#L41)
- resource.aws_securityhub_configuration_policy.baseline (modules/aws/security/securityhub-org/main.tf#L76)
- resource.aws_securityhub_configuration_policy_association.root (modules/aws/security/securityhub-org/main.tf#L93)
- resource.aws_securityhub_finding_aggregator.this (modules/aws/security/securityhub-org/main.tf#L54)
- resource.aws_securityhub_organization_admin_account.this (modules/aws/security/securityhub-org/main.tf#L45)
- resource.aws_securityhub_organization_configuration.this (modules/aws/security/securityhub-org/main.tf#L63)
...
| <a name="input_enabled_standard_arns"></a> [enabled\_standard\_arns](#input\_enabled\_standard\_arns) | Security standard ARNs enabled by the baseline configuration policy. Defaults (when empty) to FSBP + CIS v3.0.0 + NIST 800-53 r5, built from home\_region. | `list(string)` | `[]` | no |
