...
- resource.aws_networkfirewall_firewall.this (modules/aws/network/network-firewall/main.tf#L72)
- resource.aws_networkfirewall_firewall_policy.this (modules/aws/network/network-firewall/main.tf#L46)
- resource.aws_networkfirewall_logging_configuration.this (modules/aws/network/network-firewall/main.tf#L100)
- resource.aws_networkfirewall_rule_group.stateful (modules/aws/network/network-firewall/main.tf#L23)
