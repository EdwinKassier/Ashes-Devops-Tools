...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_ip_cidr_range"></a> [ip\_cidr\_range](#input\_ip\_cidr\_range) | The range of internal addresses for this subnet (e.g. 10.0.0.0/24). Must be valid CIDR notation with no host bits set. | `string` | n/a | yes |
...
| <a name="input_purpose"></a> [purpose](#input\_purpose) | Purpose of the subnet (PRIVATE, REGIONAL\_MANAGED\_PROXY, GLOBAL\_MANAGED\_PROXY, PRIVATE\_SERVICE\_CONNECT, PEER\_MIGRATION) | `string` | `null` | no |
| <a name="input_role"></a> [role](#input\_role) | Role for the subnet when purpose is REGIONAL\_MANAGED\_PROXY or GLOBAL\_MANAGED\_PROXY (ACTIVE or BACKUP) | `string` | `null` | no |
