 ...
 * and attach it to the Dev Shared VPC Host.
 */

# Example Workload: API Service
module "workload_api_service" {
  ...
  project_admin_group_email = "gcp-developers@ashes.com" # TODO: Replace with actual team group
